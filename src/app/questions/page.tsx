...
function first_few_words(question: string) {
 ...
 function AnswerForm({question}: {question: Question}) {
    return <form className="py-2" action="">
        <label className="block text-sm font-medium text-gray-700" htmlFor="answer">Answer:</label>
        <input className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" type="text" value={`in response to your question: "${first_few_words(question.question)}.."`} name="answer" />
